<template>
  <div class="app-container">
    <div class="interface-button-container">
      <el-button size="mini" type="primary" @click="create"><i class="el-icon-circle-plus-outline" />立即创建</el-button>
...
<script>
import { create } from '@/api/interfaceDefinition'
import { select } from '@/api/dict'
export default {
  name: 'InterfaceDefinitionCreate',
  data() {
    return {
      moduleList: [], dataTypeList: [],
